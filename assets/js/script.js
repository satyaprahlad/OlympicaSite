(function ($) {
    ...
    /*------------------------------------------
        = technut-project-slider
    -------------------------------------------*/
    if ($(".technut-project-slider").length) {
        $(".technut-project-slider").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 20,
            loop: true,
    ...
    -------------------------------------------*/
    if ($(".technut-testimonial-wrap").length) {
        $('.testimonial-img').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: false,
            fade: true,
            asNavFor: '.testimonial-conternt'
        });
        $('.testimonial-conternt').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
    ...
    let contactForm = document.getElementById("contact-form-main")
